...
int main()
{
    ...
    while(t--)
    {
        ...
        for(i=0;i<m-1;i++)
        {
            if(k==1)
            {
                if(s[i] == 'B' and s1[i] == 'B' and s[i+1] == 'B' and s1[i+1] == 'W')
                {
                    cout << "NO" << endl;
                    j++;
                    break;
                }
                else if(s[i] == 'B' and s1[i] == 'W' and s[i+1] == 'W' and s1[i+1] == 'B')
                {
                    cout << "NO" << endl;
                    j++;
                    break;
            ...
            {
                if(s[i] == 'B' and s1[i] == 'B' and s[i+1] == 'W' and s1[i+1] == 'B')
                {
                    cout << "NO" << endl;
                    j++;
                    break;
                }
                else if(s[i] == 'W' and s1[i] == 'B' and s[i+1] == 'B' and s1[i+1] == 'W')
                {
                    cout << "NO" << endl;
                    j++;
                    break;
