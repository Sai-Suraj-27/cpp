...
bool fcompare(pair<ll, pair<ll,ll> > p,
...
void sortByFrequency(vll &v, ll n)
{
    unordered_map<ll, pair<ll, ll> > hash; // hash map
    for (ll i = 0; i < n; i++) {
...
int main()
{
    ...
    while(t--)
    {
        ...
        else
        {
            ...
            sortByFrequency(v1,sz(v1));
            sortByFrequency(v2,sz(v2));
            i=0,j=0;
            vll v3;
